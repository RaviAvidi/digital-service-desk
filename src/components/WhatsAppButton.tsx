...
const WhatsAppButton = () => {
  ...
  const whatsappNumbers = [
    { name: "Sales Team", number: "917075699278" },
    { name: "Technical Support", number: "917075699279" },
    { name: "Customer Service", number: "917075699280" },
  ];
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300 animate-bounce rounded-full p-3"
